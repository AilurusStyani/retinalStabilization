% function [x,y,z] =GenerateStarFiled(dimensionX,dimensionY,dimensionZ,size,density)
function GenerateStarFiled(dimensionX,dimensionY,dimensionZ,size,density)
 global STARDATA;
...
baseZ=rand(1,totalDots)*dimensionZ-dimensionZ/2.0;
