% this function is coded for testing how the eye tracker work for motion type 4, and the lag between host pc and display pc
clear all;
close all;
clc;
...
TRIALINFO.headingSpeed = 5*coordinateMuilty; % cm/s
...
starPosition = [0,0,-10;0,0,-20;0,0,-30;0,0,-40;0,0,-50];
generateStars(starPosition,degree2length(STARFIELD.starSize))
